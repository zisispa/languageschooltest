...
@section('content')
    ...
    <div class="form-group text-center">
        <a href="{{ route('group.index') }}" class="btn btn-success">Ολοκλήρωση Βαθμολογίας</a>
    </div>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('grade.store') }}" method="POST">
                    ...
                    <div class="modal-body" id="gradee">
                        ...
                        <div class="form-group">
                            <label for="value">Βαθμός<span class="badge text-danger">*</span></label>
                            <input type="text" class="form-control" name="value" id="value"
                                placeholder="Δώστε Περιγραφή Βαθμού">
                        </div>

                        <div class="form-group">
                            <label for="grade_name">Περιγραφή<span class="badge text-danger">*</span></label>
                            <input type="text" class="form-control" name="grade_name" id="grade_name"
                                placeholder="Δώστε Περιγραφή Βαθμού">
                        </div>

                        <div class="form-group">
                            <label for="grade_day">Ημερομηνία<span class="badge text-danger">*</span></label>
                            <input type="text" class="form-control" name="grade_day" id="grade_day"
                                placeholder="Επέλεξε Ημερομηνία Βαθμού">
                        </div>

                        <div class="form-group">
                            <label for="semesters">Εξάμηνο<span class="badge text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="teachers">Καθηγητής<span class="badge text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="subjects">Μαθήμα<span class="badge text-danger">*</span></label>
